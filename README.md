...
> Spring Boot + Vue3 + DeepSeek API로 만든 감정 기반 개인화 도서 추천 서비스
...
중국 북경과학기술대학교 졸업 프로젝트로 개발했으며 자연어 처리(NLP)와 벡터 임베딩 기술로 "우울할 때 읽고 싶은 책" 같은 개방형 질문에 대응하는 개인화 추천을 구현했습니다.
...
### 1. AI 자동 도서 요약
- DeepSeek Reasoner API로 도서 설명을 3줄로 자동 압축
- 관리자의 수작업 없이 멀티스레드 배치 처리로 대량 요약 생성
